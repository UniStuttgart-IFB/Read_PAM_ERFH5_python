...
class erhf5_Data:
    ...
    def __init__(self, path: str, name: str, *args, **kwargs):
        self.filename = name.split(os.path.sep)[-2]
        self.h5file = name
    ...
    def _collectElements(self):
        ...
        for name_byte in array_ShellPartNames:
            ...
            if "Niederhalter_unten" in name:
                ID_lowerBlankholder_ = array_ShellPartName_ID[pos_name]
            pos_name += 1
        self.ID_stamp = ID_stamp_
        self.ID_textile = ID_textile_
        self.ID_lowerBlankholder = ID_lowerBlankholder_
        ...
        for shell in array_ShellPartIDs:
            if (
                ...
                or shell == self.ID_lowerBlankholder
            ):
                ...
                for node in nodes:
                    ...
                    if not node in nodeSavedCheck:
                        ...
                        elif shell == self.ID_lowerBlankholder:
